...
//		this.isClustered = isClustered;
	...
	public void scanAndConstructAll() throws IOException { //TODO: change to void method to scanAndConstruct?
		...
		List<List<int []>> rids = new ArrayList<List<int []>>();
		List<Integer> keyValues = new ArrayList<Integer>(leafEntries.keySet());
